...
export default function Footer() {
    return(
        ...
        <div className="FooterLink">
            ...
            <a href="#!" className="LinkTitle">{post.title}</a>
            <div className="Links">
            <a href="#!" className="LinksItem">{post.info}</a>
            <a href="#!" className="LinksItem">{post.info2}</a>
            <a href="#!" className="LinksItem">{post.info3}</a>
            <a href="#!" className="LinksItem">{post.info4}</a>
            <a href="#!" className="LinksItem">{post.info5}</a>
            </div>
            </div>
                )
            })}
